    ...
    Column(
        ...
        OutlinedTextField(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .padding(start = 20.dp, end = 20.dp),
            leadingIcon = { Icon(imageVector = Icons.Default.LocationOn, contentDescription = "Person", tint = Color.Green) },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        ...
        OutlinedTextField(
            value = name,
            onValueChange = {name = it},
            label = { Text(text = "Select Collection Date") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(start = 20.dp, end = 20.dp),
            leadingIcon = { Icon(imageVector = Icons.Default.DateRange, contentDescription = "Person", tint = Color.Green) },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
